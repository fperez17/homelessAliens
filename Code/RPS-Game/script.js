...
function randomSelection() {
  const randomIndex = Math.floor(Math.random() * SELECTIONS.length)//Gives us a number between 0 and 2
...
bannerImg.src = "data:image/jpg;base64" + mainChar;



//var mainChar = document.getElementById("img"); 

//function showImage2(){
//mainChar = sessionStorage.getItem("whichImages");; //sessionStorage.whichImage; 
//}
